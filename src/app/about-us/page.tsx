    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300 overflow-hidden">
      ...
      <div className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10 dark:opacity-20 pointer-events-none">
            <Terminal className="absolute top-10 left-10 w-32 h-32 text-gray-400 dark:text-gray-600 animate-pulse" style={{animationDuration: '4s'}} />
            <Code2 className="absolute bottom-10 right-10 w-40 h-40 text-gray-300 dark:text-gray-700 animate-bounce" style={{animationDuration: '8s'}}/>
        </div>

        <div className="relative max-w-4xl mx-auto text-center z-10">
          <h1 className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white tracking-tight mb-6 leading-tight">
            Meet the <span className="text-blue-600 dark:text-blue-500 relative inline-block">
                "Team"
                {/* Snarky underline */}
                <svg className="absolute -bottom-2 left-0 w-full h-3 text-blue-600/30 dark:text-blue-500/30" viewBox="0 0 100 10" preserveAspectRatio="none"><path d="M0 5 Q 25 0, 50 5 T 100 5" stroke="currentColor" strokeWidth="4" fill="none"/></svg>
            </span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            {teamRoles.map((role, index) => (
                <div 
                    key={index} 
                    className="group bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-800 hover:-translate-y-2 relative overflow-hidden"
                >
                    {/* The "Ghost in the Machine" Image Effect */}
                    <div className="relative w-48 h-48 mx-auto rounded-2xl overflow-hidden mb-6 shadow-inner border-2 border-gray-100 dark:border-gray-800 bg-gray-100 dark:bg-gray-800">
                    ...
                    <div className="text-center relative">
                        ...
                        <p className="text-sm font-bold text-blue-600 dark:text-blue-400 mb-4 uppercase tracking-widest">
                            {THE_HUMAN_NAME}
                        </p>
                        
                        <div className="relative">
                            <span className="absolute -top-4 -left-2 text-4xl text-gray-200 dark:text-gray-700 opacity-50">"</span>
                            <p className="text-gray-600 dark:text-gray-300 italic leading-relaxed relative z-10 px-4">
                                {role.bio}
                            </p>
                            <span className="absolute -bottom-4 -right-2 text-4xl text-gray-200 dark:text-gray-700 opacity-50">"</span>
                        </div>
                    </div>
                </div>
            ))}
...
{/* The asterisk explanation */}
          <div className="text-center mt-8 text-sm text-gray-500 dark:text-gray-400 space-y-1 font-mono">
        ...
        <div className="text-center mt-20 animate-in fade-in slide-in-from-bottom-4 delay-300">
            ...
            <a href="/contact" className="inline-flex items-center justify-center px-8 py-4 font-bold rounded-2xl bg-gray-900 text-white hover:bg-black dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
                Hire the "Team"
            </a>
        </div>
      </div>
