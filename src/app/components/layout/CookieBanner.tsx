        ...
        <div className="flex-1 flex items-start gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              UniEvents uses your browser&apos;s local storage to keep you logged in, remember your theme preference, and track your event likes. We do not use tracking cookies or analytics.
