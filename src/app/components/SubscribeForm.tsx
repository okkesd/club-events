    ...
    return (
      <div className="flex items-center gap-3 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 vibrant:bg-green-50 border border-green-200 dark:border-green-800 vibrant:border-green-200 transition-colors">
        ...
        <p className="text-sm font-medium text-green-700 dark:text-green-300">
          Subscribed! You&apos;ll receive a weekly digest of announcements and upcoming events.
        </p>
      </div>
    );
  }
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-sm overflow-hidden border border-transparent dark:border-gray-700">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Confirm Subscription</h3>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                You will receive <strong>weekly emails</strong> with
                {categoryLabel
                  ? <> announcements filtered by <span className="font-bold text-blue-600 dark:text-blue-400">{categoryLabel}</span> category</>
